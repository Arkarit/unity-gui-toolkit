...
[InitializeOnLoad]
internal static class RoslynBridgeInstaller
{
    private const string DestDir = "Assets/Plugins/Roslyn";
    private const string AsmdefFile = "Roslyn.asmdef";
