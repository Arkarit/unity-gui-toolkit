...
namespace GuiToolkit
{
	...
	public static class Constants
	{
		...
		public const int CLEAN_KERNING_TABLE_MENU_PRIORITY = 510;					  ///< Menu priority "Clean Kerning Table"
	...
	public static class StringConstants
	{
		...
		public const string CLEAN_KERNING_TABLE_MENU_NAME = MENU_HEADER + "Clean Kerning Table";										///< "Clean Kerning Table" menu entry
