...
namespace GuiToolkit
{
	public class UiKeyBindingRequester : UiRequesterBase
	{
		...
		public void Requester( string _title = null, bool _allowOutsideTap = false, UnityAction _onOk = null, UnityAction _onCancel = null, string _okText = null, string _cancelText = null )
		{
			UiMain.Instance.KeyBindings.BeginChangeBindings();

			if (_title == null)
				_title = _("Key Bindings");
