...
namespace GuiToolkit.Exceptions
{
	...
	public sealed class UiViewNotFoundException : InvalidOperationException
	{
		public UiViewNotFoundException( Type _type )
			: base($"Asset load by type failed for '{_type.Name}'")
		{ }
	}
}
