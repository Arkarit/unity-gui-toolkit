...
public const int LOCA_MISC_FIX_AUTO_LOCALIZE_MENU_PRIORITY           = 60;
		...
		public const int LOCA_MISC_FIND_NON_LOCALIZED_MENU_PRIORITY          = 80;
	...
	public static class StringConstants
	{
		...
		public const string AI_HEADER = MENU_HEADER + "AI/";
		...
		public const string AI_GENERATE_SCREEN_CATALOG_MENU_NAME = AI_HEADER + "Generate Screen Catalog";
		...
		public const string AI_TAG_STANDARD_ELEMENTS_TEST_MENU_NAME = AI_HEADER + "Tag Standard Elements (Test)";
		public const string AI_READ_SELECTED_PREFAB_MENU_NAME = AI_HEADER + "Read Selected Prefab (to JSON)";
		...
		public const string CREATE_SPRITE_SHEET_GENERATOR = MENU_HEADER + "Generators/Directional Sprite Sheet";
		public const string CREATE_DIRECTIONAL_SPRITE_SHEET = MENU_HEADER + "Directional Sprite Sheet";
		...
		public const string LOCA_MISC_FIND_NON_LOCALIZED_MENU_NAME          = LOCA_MISC_HEADER + "Find Non Localized\u2026";
