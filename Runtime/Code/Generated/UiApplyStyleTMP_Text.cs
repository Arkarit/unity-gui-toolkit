...
namespace GuiToolkit.Style
{
	...
	public class UiApplyStyleTMP_Text : UiAbstractApplyStyle<TMPro.TMP_Text, UiStyleTMP_Text>
	{
		protected override void ApplyImpl()
		{
			...
			if (SpecificStyle.EmojiFallbackSupport.IsApplicable)
				try { SpecificComponent.emojiFallbackSupport = Tweenable ? SpecificStyle.EmojiFallbackSupport.Value : SpecificStyle.EmojiFallbackSupport.RawValue; } catch {}
			...
			if (SpecificStyle.FontFeatures.IsApplicable)
				try { SpecificComponent.fontFeatures = Tweenable ? SpecificStyle.FontFeatures.Value : SpecificStyle.FontFeatures.RawValue; } catch {}
			...
			if (SpecificStyle.TextWrappingMode.IsApplicable)
				try { SpecificComponent.textWrappingMode = Tweenable ? SpecificStyle.TextWrappingMode.Value : SpecificStyle.TextWrappingMode.RawValue; } catch {}
		...
		protected override void RecordImpl()
		{
			...
			if (SpecificStyle.EmojiFallbackSupport.IsApplicable)
				try { SpecificStyle.EmojiFallbackSupport.RawValue = SpecificComponent.emojiFallbackSupport; } catch {}
			if (SpecificStyle.EnableAutoSizing.IsApplicable)
			...
			if (SpecificStyle.FontFeatures.IsApplicable)
				try { SpecificStyle.FontFeatures.RawValue = SpecificComponent.fontFeatures; } catch {}
			if (SpecificStyle.FontSharedMaterial.IsApplicable)
			...
			if (SpecificStyle.TextWrappingMode.IsApplicable)
				try { SpecificStyle.TextWrappingMode.RawValue = SpecificComponent.textWrappingMode; } catch {}
			if (SpecificStyle.WordSpacing.IsApplicable)
		...
		public override UiAbstractStyleBase CreateStyle(UiStyleConfig _styleConfig, string _name, UiAbstractStyleBase _template = null)
		{
			...
			if (_template != null)
			{
				...
				result.EmojiFallbackSupport.Value = specificTemplate.EmojiFallbackSupport.Value;
				result.EmojiFallbackSupport.IsApplicable = specificTemplate.EmojiFallbackSupport.IsApplicable;
				...
				result.FontFeatures.Value = specificTemplate.FontFeatures.Value;
				result.FontFeatures.IsApplicable = specificTemplate.FontFeatures.IsApplicable;
				...
				result.TextWrappingMode.Value = specificTemplate.TextWrappingMode.Value;
				result.TextWrappingMode.IsApplicable = specificTemplate.TextWrappingMode.IsApplicable;
			...
			try { result.EmojiFallbackSupport.Value = SpecificComponent.emojiFallbackSupport; } catch {}
			...
			try { result.FontFeatures.Value = SpecificComponent.fontFeatures; } catch {}
			...
			try { result.TextWrappingMode.Value = SpecificComponent.textWrappingMode; } catch {}
