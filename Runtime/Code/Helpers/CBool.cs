...
{
	/// \brief A struct mimicking C "bool" handling.
	/// 
	/// As C doesn't know bools but only ints, you can do all kinds of numerical and logical operations on them. <br>
	/// C# is different; it strictly distinguishes between bool (only logical operations) and int (only numerical operations) <br>
	/// CBool mimicks this behaviour by implicit conversions, so that you can write CBool cb = 100 as well as CBool cb = true. <br>
